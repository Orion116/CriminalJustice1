...
3. To distribute the program copy the CriminalJustice.jar file, 7z.exe, the lib 
   folder, and the report folder to the USB drive. 
...
6. You can add more Complainant's, Witness's, etc, by clicking add. Clicking add will
   clear the text boxes so click save first. It will auto save before clearing in the 
   final version.